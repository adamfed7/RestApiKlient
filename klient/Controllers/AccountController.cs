...
namespace klient.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController()
        {
            ...
            {
                new UserModel() { UserId = 1, Username = "admin", Password = "123", Role = "Admin", Email = "admin@domain.com" },
                new UserModel() { UserId = 2, Username = "user", Password = "123", Role = "User", Email = "user1@domain.com" }
            };
        }
